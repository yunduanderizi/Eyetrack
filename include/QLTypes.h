...
/// 
/// @copyright 1996 - 2019, EyeTech Digital Systems
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_DEVICE_EYE_POSITION_DATA_SOURCE
///
/// @brief By default the eye position data is independent of the pixel data sent by AEye based
/// devices. This setting can specify that the eye position data be overwritten by the values from
/// the pixel data. This allows the eye position data to be synchronized with the image pixel data.
///
/// @see QLEyePositionDataSource
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_DEVICE_EYE_POSITION_DATA_SOURCE "DeviceEyePositionDataSource"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_DEVICE_DISTANCE_FILTER_VALUE
///
/// @brief The amount of time in milliseconds over which the device will filter the calculated
/// distance value. Setting this value less than or equal to zero will cause the distance value to
/// be unfiltered.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_DEVICE_DISTANCE_FILTER_VALUE "DeviceDistanceFilterValue"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_DEFAULT_DEVICE_LENS_FOCAL_LENGTH
///
/// @brief The focal length in centimeters of the lens when the device was manufactured.
///
/// If the lens was changed by the user then this setting would no longer be correct. This is a
/// read only setting. Attempts to modify this value on the device will be ignored. This setting is
/// only valid if the setting QL_SETTING_DEFAULT_VALID is true.
///
/// @see QL_SETTING_DEFAULT_VALID
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_DEFAULT_DEVICE_LENS_FOCAL_LENGTH "DefaultDeviceLensFocalLength"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_DEFAULT_DEVICE_DISTANCE
///
/// @brief The optimal user distance of the device in centimeters.
///
/// When the device was manufactured the lens was focused so that tracking performance was
/// optimized at this distance. If the user has changed the focus of the lens then this setting
/// would no longer be correct. This is a read only setting. Attempts to modify this value on the
/// device will be ignored. This setting is only valid if the setting QL_SETTING_DEFAULT_VALID is
/// true.
///
/// @see QL_SETTING_DEFAULT_VALID
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_DEFAULT_DEVICE_DISTANCE "DefaultDeviceDistance"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_DEFAULT_VALID
///
/// @brief The valid flag which indicates if the default settings are valid.
///
/// It is possible for default values to not be written to the flash memory embedded in the device.
/// If this is the case then this flag will be false. None of the other default settings are valid
/// unless this flag is set.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_DEFAULT_VALID "DefaultValid"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_SYSTEM_CALIBRATION_MARGIN_LEFT
///
/// @brief The amount, as a percentage of the tracking area, to bring the calibration targets in
/// from the left side of the tracking area.  The valid range is [0,50).  The default margin is 1.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_SYSTEM_CALIBRATION_MARGIN_LEFT "SystemCalibrationMarginLeft"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_SYSTEM_CALIBRATION_MARGIN_RIGHT
///
/// @brief The amount, as a percentage of the tracking area, to bring the calibration targets in
/// from the right side of the tracking area.  The valid range is [0,50).  The default margin is 1.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_SYSTEM_CALIBRATION_MARGIN_RIGHT "SystemCalibrationMarginRight"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_SYSTEM_CALIBRATION_MARGIN_TOP
///
/// @brief The amount, as a percentage of the tracking area, to bring the calibration targets in
/// from the top side of the tracking area.  The valid range is [0,50).  The default margin is 1.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_SYSTEM_CALIBRATION_MARGIN_TOP "SystemCalibrationMarginTop"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_SYSTEM_CALIBRATION_MARGIN_BOTTOM
///
/// @brief The amount, as a percentage of the tracking area, to bring the calibration targets in
/// from the bottom side of the tracking area.  The valid range is [0,50).  The default margin is 1.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_SYSTEM_CALIBRATION_MARGIN_BOTTOM "SystemCalibrationMarginBottom"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_EYEWAKE_COMMAND_ENABLE
///
/// @brief This enables the EyeWake feature.  There is a flash setting that must be Enabled on the
/// camera for this to be an enabled feature.  If you cannot get the camera to enable using this
/// setting, then the flash setting is probably not set and you will need to contact EyeTech for
/// options to enable it.
///
/// This is a boolean value.  A value of true will try to enable it.  Reading the value will give
/// the current status.  The value must be true to allow the system to utilize the EyeWake mode.
/// The default value is false.
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_EYEWAKE_COMMAND_ENABLE				"EyeWakeCommandEnable"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_EYEWAKE_COMMAND_SLEEP
///
/// @brief If the EyeWake is enabled, then this setting can put the system into EyeWake sleep mode.
/// If the EyeWake has not been enabled, then this setting has no effect.
///
/// This is a boolean setting.  A value of true will put the system into EyeWake sleep mode
/// (assuming that the QL_SETTING_EYEWAKE_COMMAND_ENABLE has been set to true and camera is capable
/// of using the EyeWake feature).  A value of false will wake the system up if it is in EyeWake
/// sleep mode.
///
/// @see QL_SETTING_EYEWAKE_COMMAND_ENABLE
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_EYEWAKE_COMMAND_SLEEP				"EyeWakeCommandSleep"

////////////////////////////////////////////////////////////////////////////////////////////////////
/// @def QL_SETTING_EYEWAKE_MODE
///
/// @brief If the EyeWake is enabled, then this setting specifies which eyes to use.  This uses
/// the QLDeviceEyesToUse enumeration to specify the eye or eyes to use in gaze determination.
///
/// This follows the enumeration for QLDevicesEyesToUse and is a s32 value.  This defaults to
/// QL_DEVICE_EYES_TO_USE_LEFT_OR_RIGHT, or a value of 2.
///
/// @see QLDeviceEyesToUse
////////////////////////////////////////////////////////////////////////////////////////////////////
#define QL_SETTING_EYEWAKE_MODE							"EyeWakeMode"
...
typedef enum
{
	...
	/// A user driven 9 point calibration.
	QL_CALIBRATION_TYPE_USERDRIVEN_9 = 3
} QLCalibrationType;
...
typedef enum
{
    /// The device will automatically adjust the gain value.
...
typedef enum
{
    ...
    /// represented by the setting
    /// @ref QL_SETTING_DEVICE_GAZE_POINT_FILTER_VALUE. This produces approximately
    ...
    /// The mean gaze point value over the last X number of frames, where X equals the value
    /// represented by the setting
    /// @ref QL_SETTING_DEVICE_GAZE_POINT_FILTER_VALUE.
    QL_DEVICE_GAZE_POINT_FILTER_MEAN_FRAMES				= 6,

    /// The mean gaze point value over the last X number of frames, where X is the number of
    /// frames gathered over the amount of milliseconds represented by the setting
    /// @ref QL_SETTING_DEVICE_GAZE_POINT_FILTER_VALUE. 
...
///
/// @brief Values that identify which IR light mode to use.
///
...
typedef enum
{
	...
	/// DetectFocusedTarget requires that one target be calibrated
	QL_ERROR_ONE_CALIBRATED_TARGET_NEEDED = 21
} QLError;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// @enum QLEyePositionDataSource
///
/// @brief Defines where the eye position data in the frameData structure is being derived from
///
/// @see QL_SETTING_DEVICE_EYE_POSITION_DATA_SOURCE
////////////////////////////////////////////////////////////////////////////////////////////////////
typedef enum
{
    /// The eye position data (the X and Y positions of the pupil and glints in the QLEyeData 
    /// structure) is updated on a frame by frame basis. This setting provides the most up to date
    /// eye position data, but it is asynchronous from the image data found in QLImageData.PixelData.
    QL_EYE_POSITION_DATA_DEFAULT = 0,

    /// The eye position data is updated when the image data found in QLImageData.PixelData is 
    /// updated. This causes the eye position data to be synchronized with the image pixel data, but
    /// asynchronous with the rest of the gaze data. This is useful when displaying the image pixel
    /// data marking where the eyes are on the image.
    QL_EYE_POSITION_DATA_IMAGE =   1
} QLEyePositionDataSource;
...
typedef struct
{
    /// The pixel data of the image. The data is single channel gray-scale with 8-bits per pixel.
    ...
    /// A number to identify the PixelData frame.  If this number changes from the last check, then
    /// the PixelData pointer buffer has been updated with new PixelData.
    long           PixelFrameNumber;
...
typedef struct
{
    ...
    /// The distance from the device to the user in centimeters. A value less than or equal to zero 
    /// indicates the distance could not be calculated for this frame. This value is more accurate 
    /// the closer the settings QL_SETTING_DEVICE_IMAGE_PROCESSING_EYE_RADIUS_LEFT and 
    /// QL_SETTING_DEVICE_IMAGE_PROCESSING_EYE_RADIUS_RIGHT are to the actual eye radius. 
    float               Distance;
